afda_data = [
    ...
    ("AFDA.DA.3", "The student will calculate and interpret probabilities, including those in contextual situations.", [
        ...
        "AFDA.DA.3.h Calculate the number of permutations of n objects taken r at a time, without repetition.",
        "AFDA.DA.3.i Calculate the number of combinations of n objects taken r at a time, without repetition."
    ]),
    ("AFDA.DA.4", "The student will describe and apply the properties of normal distribution, including those in contextual situations.", [
        ...
        "AFDA.DA.4.d Calculate and interpret the z-score for a data point, given the mean and the standard deviation.",
        "AFDA.DA.4.e Compare two sets of normally distributed data using a standard normal distribution and z-scores, given the mean and the standard deviation.",
